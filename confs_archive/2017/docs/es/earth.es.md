...
## Taller Latinoamericano de Python y Ciencias de la Tierra

Las Ciencias de la Tierra son escenciales para mitigar el impacto de desastres, del cambio climático y para una prospección y explotación responsable de los recursos. Se impone la búsqueda de un equilibio entre las sociedades de consumo y la preservación de los ecosistemas.
...
## Tópicos del Taller de Ciencias de la Tierra ##

Algunas áreas específicas de interés son:

* Análisis de datos sísmicos
* Remoción de dióxido de carbono atmosférico
* Combustibles libres de carbono
* Simulaciones de clima y pronósticos del tiempo
* Sistemas ecológicos cerrados
* Análisis computacional de la influencia topográfica en resultados de prospección
* Magnetometría computacional y aplicaciones en mapeo geológico
* Métodos computacionales de prospección basados en técnicas de ángulo de refracción entre capas
* Métodos galvánicos y magneto-telúricos de medición resistividad
* Interpretación de mediciones electromagnéticas
* Métodos de interpretación basados en reflexión y refracción de ondas esféricas
* Ciencias naturales como servicio (NSaaS)
* Cálculos numéricos e interpretación de métodos de conducción de corriente directa
* Análisis numérico para determinar presencia de flujo de agua subterránea
* Agricultura de precisión
* Propagación de ondas elásticas en medios aleatoriamente heterogeneos
* Reducción e interpretación de datos de campos potenciales. Anomalías magnéticas y gravitacionales
* Interpretación sismica
* Simulación para mitigación de desastres
* Agricultura vertical
* Visualización de datos climatológicos
