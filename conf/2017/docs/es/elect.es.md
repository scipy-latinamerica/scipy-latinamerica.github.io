...
## Taller Latinoamericano de Python, Automática y Control de Procesos

Investigadores y emprendedores se reunirán en La Habana para debatir acerca del potencial de la robótica, la inteligencia artificial y la ingeniería eléctrica para implementar aplicaciones disruptivas, explicando cómo Python permitió obtener una ventaja competitiva.
...
## Tópicos del Taller de Automática y Control de Procesos ##

Algunas áreas específicas de interés son:

* Impresión 3D
* Soluciones para displays 3D y monitores holográficos
* Procesamiento adaptivo de señales
* Robots para la agricultura
* Robots humanoides
* Vehículos autónomos
* Biónica
* Algoritmos y programación para claytronics
* Soluciones robóticas en la nube
* Sistemas con adaptabilidad colectiva
* Manufactura basada en computadora
* Dispositivos holográficos generados por computadora
* Sensores digitales de medición de fragancias
* Vehículos eléctricos
* Sistemas de redes de alta eficiencia energética
* Tecnologías de smart-grid
* Sistemas expertos para la industria
* Vehículos voladores
* Redes de sensores de nueva generación
* Prototipado y simulación de hardware
* Interfaces robot-operador
* Inteligencia artificial para detección de fallas
* Aprendizaje automatizado (machine Learning) en aplicaciones de control
* MyHDL
* Redes de Petri (diseño y verificación de sistems, protocolos y redes)
* Exoesqueletos
* Sistemas en tiempo real
* Diseño, desarrollo y control de robots
* Cirugía asistida por robots
* Robots modulares auto-configurables
* Auto-organización, auto-estabilizaación y computación autónoma
* Diseño simulación de soluciones System-on-Chip
* Sistemas inteligentes de control basados en agentes
* Sistemas de comunicación para vehículos
* Prototipado virtual y prueba de sistema ciber-físicos
